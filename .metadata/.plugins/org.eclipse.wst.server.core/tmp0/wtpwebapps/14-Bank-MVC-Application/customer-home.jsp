	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		...
		<div class="collapse navbar-collapse">
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item">
					<a class="nav-link" href="CustomerController?action=viewCustomer&user_name=<%= user_name %>">View Profile</a>
				</li>
			</ul>
		</div>
	</nav>
			...
			<div class="col-md-12">
				<div class="jumbotron text-center">
					...
					<p class="lead">
						...
						<a class="btn btn-info btn-lg" href="CustomerController?action=viewCustomer&user_name=<%= user_name %>" role="button">
							Edit Profile
						</a>
					</p>
				</div>
